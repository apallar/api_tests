...
#TC 1: GET https://jsonplaceholder.typicode.com/users  should return 200 OK response code and the number of users should be 10     
...
#TC 2: GET https://jsonplaceholder.typicode.com/users - When id=8, it should return name=Nicholas Runolfsdottir V
...
#TC 3: POST https://jsonplaceholder.typicode.com/users - Add a user given the test data and verify that the response code=201
